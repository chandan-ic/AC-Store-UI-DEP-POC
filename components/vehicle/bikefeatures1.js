export default function BikeFeatures1() {
    return (
        <section id="performance" className="acSec bg-primary">
                    ...
                    <div className="flex   items-center lg:justify-self-start">
                        ...
                        <div className="w-full">
                            <div className="flex flex-col  md:grid grid-cols-10 grid-rows-4">
                                ...
                                <div className="row-start-4 row-end-4 col-start-1 col-end-3 pb-5 ">
                                    <h5>Performance</h5>
...
border-none h-full -m-16 -ml-20 lg:-ml-16"
                                ...
                                <div className="row-start-4 row-end-4 col-start-9 col-end-11 pb-5 ">
                                      <h5>Comfort</h5>
 ...
 col-end-9 mt-5 sm:mt-0 ">
                            ...
                            <div className="row-start-5 row-end-5 col-start-10 col-end-12 
">
