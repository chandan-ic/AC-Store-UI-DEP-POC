...
export default function CompareBikes() {
  return (
    <section className="bg-primary h-full m-auto">
      <div className="flex flex-col pp-sec-height container sm:pt-10 pt-2">
        ...
        <div className="flex flex-col sm:flex-row w-full ">
          <div className="w-full sm:w-1/2 flex flex-col items-center">
            <div className="inline-flex justify-center  items-center text-black flex-row pt-10 sm:pt-20">
              ...
              <div className="align-middle  sm:pt-8  mr-3 sm:mr-0 sm:ml-0 ml-2 justify-center">
                <h2 className="font-extrabold from-black text-xl sm:text-4xl">
                  {" "}
                  V/s
                </h2>
              </div>
            ...
            <div className="inline-flex flex-col items-center sm:pt-10 sm:ml-8 sm:block hidden">
              <div className="pb-10 pt-5 ">
                <button className="modelButton ">COMPARE BIKES</button>
              </div>
            </div>
          </div>
          <div className="w-full sm:w-1/2 ">
            <div className="w-full  flex flex-row justify-center mt-10  sm:mt-20  sm:flex-row ">
              ...
              <div className="align-middle pt-10 sm:pt-14  mr-3 sm:mr-0 sm:ml-0 ml-2 justify-center">
                <h2 className="font-semibold from-black text-xl sm:text-4xl">
                  {" "}
                  V/s
                </h2>
              </div>
  ...
  /*<div className="flex w-full sm:flex-row flex-col pt-10">
                    <div className=" flex flex-col w-full sm:w-3/4">
                        ...
                        <div className="inline-flex flex-row pt-5" >
                            <div >
                                <Image className="w-76" src="images/homeImage2.png" />
                            </div>
                            <div >
                                <Image className="w-76" src="images/compareHome.png" />
                            </div>
                        </div>
                    </div>
