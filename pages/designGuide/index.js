    ...
    <div>
      <section>
        <div className="container">
          <h1 className="dpH1">Book Your Bikes Online Now! </h1>
          <p className="dpP">
            Now, you can buy your favorite bike completely online.{" "}
          </p>
      ...
      <section className=" p-20 mt-10 bg-gray-100">
        <div className="container">
          <h2 className="dpH2 text-center mb-10">
          ...
          <div>
            <ul className="justify-center flex justify-around">
              <li className=" bg-yellow-200 text-center w-1/5 text-xs font-bold uppercase px-5 py-2 shadow-lg rounded block leading-normal m-2 tracking-widest">
                ...
                <span className="mt-2">Select Bike</span>
              </li>
              <li className="text-center w-1/5 text-xs  uppercase px-5 py-2 shadow-sm  block leading-normal m-2 tracking-widest">
                ...
                <span className="mt-2">Select Location</span>
              </li>
              <li className=" text-center w-1/5 text-xs  uppercase px-5 py-2 shadow-sm rounded block leading-normal m-2 tracking-widest">
                ...
                <span className="mt-2">Select Schedule</span>
              </li>
              <li className=" text-center w-1/5 text-xs  uppercase px-5 py-2 shadow-sm rounded block leading-normal m-2 tracking-widest">
                <svg
                  className="block  m-auto w-4 h-4"
                ...
                <span className="mt-2">Enter your details</span>
              </li>
            </ul>
          </div>
          <div className="container pt-10">
            <div>
              <p className="dpP mb-2">Find a nearest dealer</p>
            </div>
            <div className="flex">
              ...
              <div className=" w-1/3 p-2">
                <div className="w-full ">
                  <div className="bg-white  flex border border-gray-300 rounded">
                    ...
                    <div className="px-2 bg-yellow-200">
                      <button className="cursor-pointer w-6 h-full flex items-center text-xs text-gray-700 outline-none focus:outline-none">
                        GO
                      </button>
                    </div>
                  </div>
              ...
              <div className=" w-1/3 p-2">
                <div className="w-full ">
                  <div className="bg-white  flex border border-gray-300 rounded ">
                    ...
                    <input
                      value=""
                      placeholder="Select your ride type"
      ...
      <section className="m-10 ">
        <div className="container">
          <h3 className="dpl">Chip</h3>
          <div className="inline-flex items-center  rounded-md bg-white border border-gray-200 p-px">
            <span className="px-1 text-sm">filter1</span>
            <button
              className="bg-gray-200 hover:bg-gray-400 rounded-sm hover:border-yellow-400 transform text-gray-500 active:bg-pink-600 p-1 font-bold uppercase text-xs shadow rounded-full hover:shadow-lg hover:border hover:text-yellow-300 outline-none focus:outline-none mr-1 mb-1 transition: background-color 400ms ease-out, color 400ms ease-out, border-color 400ms ease-out; "
              type="button"
            >
              <svg
                className="w-3 h-3"
      ...
      <section className="m-10 ">
        <div className="container">
          <h3 className="dpl">Close Button</h3>
          <button
            className="bg-gray-200 hover:bg-gray-400 hover:border-yellow-400 transform text-gray-500 active:bg-pink-600 p-1 font-bold uppercase text-xs shadow  rounded-full hover:shadow-lg hover:border hover:text-yellow-300 outline-none focus:outline-none mr-1 mb-1 transition: background-color 400ms ease-out, color 400ms ease-out, border-color 400ms ease-out; "
            type="button"
          >
            <svg
              className="w-3 h-3"
        ...
        <div className=" mt-10 p-10 border-t border-gray-200">Border -top</div>
      ...
      <section className="m-20 ">
        <div className="container">
          <div className="w-1/4 relative text-gray-600">
            <input
              type="search"
              name="search"
              placeholder="Search"
              className="bg-gray-100 h-8 px-5 pr-10 rounded-full text-sm focus:outline-none"
            />
      ...
      <section className="m-20 ">
        <div className="container">asfdasdf</div>
      </section>
              ...
              <div className="h-full border-2 border-gray-200 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center flex-wrap ">
                    <a className="bg-yellow-300 h-4 animate-pulse mt-2 w-32 inline-flex items-center md:mb-2 lg:mb-0"></a>
                    <span className="bg-yellow-300 w-16 mt-2 h-4 animate-pulse mr-3 px-2 inline-flex items-center ml-auto leading-none text-sm pr-5 py-1"></span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
            ...
            >
              <div className="relative pb-48 overflow-hidden">
                <img
                  className="p-2 absolute inset-0 h-full w-full object-cover"
            ...
            <div className="space-y-4">
              <ul className="bg-white p-6 h-auto m-b-2 m-t-2 border">
                <li className="flex pb-2 align-middle">
                  ...
                  <h4 className="align-middle dpL uppercase text-sm tracking-wider pt-2 pb-4 font-bold">
                    khivraj Bajaj{" "}
                  </h4>
                </li>
                ...
                <li className=" flex justify-end text-right pt-2 pb-2 border-t border-gray-200">
                  <button
                    type="button"
                    className="mt-2 focus:outline-none text-yellow-500 text-sm py-1.5 px-5  bg-gray-100 hover:bg-yellow-400 hover:text-gray-700 hover:shadow-lg flex items-center  transition-colors duration-1000 ease-out"
                  >
                    <svg
              ...
              <ul className="bg-white p-6 h-auto m-b-2 m-t-2 border">
                ...
                <li className=" flex justify-end text-right pt-2 pb-2 border-t border-gray-200">
                  <button
                    type="button"
                    className="border-1 border-transparent hover:border-gray-500 mt-2 focus:outline-none text-yellow-500 text-sm py-1.5 px-5  bg-gray-100 hover:bg-yellow-400 hover:text-gray-700 hover:shadow-lg flex items-center  transition-colors duration-1000 ease-out"
                  >
                    <svg
                      className="w-4 h-4 mr-2"
                      xmlns="http://www.w3.org/2000/svg"
